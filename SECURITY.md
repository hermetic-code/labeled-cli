...
1. Navigate to the [**Security** tab](https://github.com/hermetic-code/labeled-cli/security/advisories/new) at the top of the main repository page on GitHub.
2. Click on **Vulnerability disclosure** in the left sidebar.
